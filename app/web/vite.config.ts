  ...
  return {
    ...
    define: command === 'build'
      ...
      : {
          ...
          'import.meta.env.VITE_AUTH_AUTHORITY': JSON.stringify('http://localhost:7093'),
          'import.meta.env.VITE_OIDC_CLIENT_ID': JSON.stringify('customer-web'),
          'import.meta.env.VITE_OIDC_SCOPE': JSON.stringify('openid profile roles concertable.customer.api concertable.search.api offline_access'),
          ...
          'import.meta.env.VITE_SEARCH_API_URL': JSON.stringify('http://localhost:7097/api'),
          'import.meta.env.VITE_PAYMENT_API_URL': JSON.stringify('http://localhost:7098/api'),
        },
    resolve: {
      alias: [
