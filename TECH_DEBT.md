...
Mirror of the B2B item in `api/Concertable.B2B/TECH_DEBT.md`. Tracked by [`plans/REPOSITORY_PER_MICROSERVICE_MIGRATION.md`](../../plans/REPOSITORY_PER_MICROSERVICE_MIGRATION.md), checkpoints 2 and 4.
